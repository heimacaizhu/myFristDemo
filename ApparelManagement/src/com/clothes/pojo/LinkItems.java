 ...
 *
 */
public class LinkItems implements Serializable {
	//id
    private String liId;
    //联系的客户
   ...
   //联系内容
	...
	public String toString() {
		return "LinkItems [liId=" + liId + ", customer=" + customer + ", employee=" + employee + ", content=" + content
				+ ", liDate=" + liDate + ", liState=" + liState + "]";
	}
