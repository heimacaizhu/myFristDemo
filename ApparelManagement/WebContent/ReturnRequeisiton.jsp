...
<script type="text/javascript">
	...
	function toStart(curr) {
		$.ajax({
			type : "post",
			url : "apply/showAllApply.do?ap_state=1&ap_type=4",
			dataType : "json",
			success : function(data) {
				...
				$(data.rows).each(
					function(index, content) {
						...
						str += '&nbsp;|&nbsp;<a href="javascript:nagativeApply(\''+content.ap_id+'\')">否定申请</a>&nbsp;|&nbsp;<a href="javascript:agreeApply(\''+content.ap_id+'\')">同意申请</a></td>';
						str += "</tr>";
					})
	...
	function toYesApply() {
		$.ajax({
			type : "post",
			url : "apply/showAllApply.do?ap_state=3&ap_type=4",
			dataType : "json",
			success : function(data) {
				var str = "";
				$(data.rows).each(
	...
	function toNoApply() {
		$.ajax({
			type : "post",
			url : "apply/showAllApply.do?ap_state=2&ap_type=4",
			dataType : "json",
			success : function(data) {
				var str = "";
				$(data.rows).each(
