...
<div style="padding: 10px">
    <table class="layui-table" lay-skin="line">
        ...
        <tr>
            ...
            <td>
                <select name="quiz1">
                    <option value="正常入库" selected="">正常入库</option>
    ...
    <!--按钮-->
    <div><button class="layui-btn layui-btn-radius btn_search_emp" style="display: inline;position: absolute;bottom:30px;left: 83%; " >一键入库</button></div>
</div>
</body>
</html>
